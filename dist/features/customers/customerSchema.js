...
export const GetCustomerSchema = z
    ...
    .refine((data) => data.minProbability === undefined ||
    ...
    .refine((data) => data.minTenure === undefined ||
...
export const UpdateCustomerSchema = z.object({
    ...
    SeniorCitizen: z.union([z.literal(0), z.literal(1)]).optional(),
    Partner: YesNoSchema.optional(),
    Dependents: YesNoSchema.optional(),
    tenure: z.number().int().min(0).optional(),
    Contract: ContractSchema.optional(),
    PaperlessBilling: YesNoSchema.optional(),
    PaymentMethod: PaymentMethodSchema.optional(),
    MonthlyCharges: z.number().min(0).optional(),
    TotalCharges: z.number().min(0).optional(),
    PhoneService: YesNoSchema.optional(),
    MultipleLines: MultipleLinesSchema.optional(),
    InternetService: InternetServiceSchema.optional(),
    OnlineSecurity: ServiceOptionSchema.optional(),
    OnlineBackup: ServiceOptionSchema.optional(),
    DeviceProtection: ServiceOptionSchema.optional(),
    TechSupport: ServiceOptionSchema.optional(),
    StreamingTV: ServiceOptionSchema.optional(),
    StreamingMovies: ServiceOptionSchema.optional(),
